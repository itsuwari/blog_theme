...
<div class="col-md-3">
	<form method="post" action="" class="panel-body">
		<div class="input-group">
			<div class="form-control-wrapper">
				<input type="text" name="s" class="form-control floating-label" placeholder="Search" size="32" />
			</div>
	...
	<div class="panel panel-info">
		...
		<div class="tags_box">
			<?php if($tags->have()): ?>
				<?php while ($tags->next()): ?>
				    <a href="<?php $tags->permalink(); ?>" rel="tag" class="item size-<?php $tags->split(5, 10, 20, 30); ?>" title="<?php $tags->count(); ?> tags"><?php $tags->name(); ?><span class="badge pull-right"> <?php $tags->count(); ?></span></a>
				<?php endwhile; ?>
			<?php else: ?>
				<a class="item"><?php _e('No any tag'); ?></a>
			<?php endif; ?>
		</div>
	</div>
	...
	<div class="panel panel-info">
	    ...
	    <div class="other_box">
	       <a href="<?php $this->options->feedUrl(); ?>" class="item"><?php _e('Posts RSS'); ?></a>
